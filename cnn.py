...
path = f"predicted_dataset/cnn/GW{gameweek}"
...
if 'lasso' in predictions_df2.columns:
    if pd.isnull(predictions_df2.loc[gameweek, 'cnn']) or predictions_df2.loc[gameweek, 'cnn']==0:
        predictions_df2.loc[gameweek-1, 'cnn'] = performance
    else:
        predictions_df2.loc[gameweek-1, 'cnn'] += performance
...
test_copy0[test_copy0["position"]=="DEF"][["name","team","minutes"]].to_csv(f"predicted_dataset/cnn/GW{gameweek}/defenders_minutes.csv")
test_copy0[test_copy0["position"]=="GK"][["name","team","minutes"]].to_csv(f"predicted_dataset/cnn/GW{gameweek}/goalkeepers_minutes.csv")
test_copy0[test_copy0["position"]=="MID"][["name","team","minutes"]].to_csv(f"predicted_dataset/cnn/GW{gameweek}/midfielders_minutes.csv")
test_copy0[test_copy0["position"]=="FWD"][["name","team","minutes"]].to_csv(f"predicted_dataset/cnn/GW{gameweek}/forwards_minutes.csv")


# In[32]:


test[test["position"]=="DEF"][["name","team","points","value"]].sort_values(by="points",ascending=False).to_csv(f"predicted_dataset/cnn/GW{gameweek}/defenders_points.csv")
test[test["position"]=="GK"][["name","team","points","value"]].sort_values(by="points",ascending=False).to_csv(f"predicted_dataset/cnn/GW{gameweek}/goalkeepers_points.csv")
test[test["position"]=="MID"][["name","team","points","value"]].sort_values(by="points",ascending=False).to_csv(f"predicted_dataset/cnn/GW{gameweek}/midfielders_points.csv")
test[test["position"]=="FWD"][["name","team","points","value"]].sort_values(by="points",ascending=False).to_csv(f"predicted_dataset/cnn/GW{gameweek}/forwards_points.csv")
